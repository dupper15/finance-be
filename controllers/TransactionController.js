...
export class TransactionController extends BaseController {
    ...
    async getAll(req, res, next) {
        try {
            ...
            const result = await this.transactionService.getByUserId(req.user.id, filters, options);
    ...
    async update(req, res, next) {
        try {
            const transaction = await this.transactionService.update(req.user.id, req.params.id, req.body);
    ...
    async getStatsSummary(req, res, next) {
        try {
            ...
            const summary = await this.transactionService.getStatsSummary(req.user.id, start_date, end_date);
